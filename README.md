...
Также в почтовом ящике необходимо создать отдельную папку с названием `resolvehub`.
В этой папке необходимо создать правило, чтобы приходили сообщения с темой, содержащей подстроку `[resolvehub]`.
Таким образом на письма без указания этой подстроки будет приходить автоответ с ошибкой создания задачи.
