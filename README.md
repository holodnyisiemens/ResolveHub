...
Также важный момент. В почтовом ящике необходимо создать отдельную папку с названием ResolveHub.

В этой папке необходимо создать правило, чтобы приходили сообщения только с темой ResolveHub.
