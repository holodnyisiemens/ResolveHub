...
class TestEmployeeRepository:
    async def _create_test_employee(
        self, employee_repository: EmployeeRepository, employee_data: EmployeeAddDTO
    ) -> Employee:
    ...
    async def test_create_employee(self, employee_repository: EmployeeRepository):
        employee = await self._create_test_employee(
            employee_repository, employee_data_1
        )
    ...
    async def test_get_by_username(self, employee_repository: EmployeeRepository):
        ...
        found_employee = await employee_repository.get_by_username(
            employee_data_1.username
        )
